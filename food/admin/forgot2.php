                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="images/icon/nutbutlogo.png" alt="NUTBUT">
                            </a>
                        </div>

                        <div class="login-panel panel panel-default">                  
                    <div class="panel-heading">
                        <h3 class="panel-title" align="center">Reset Your Password</h3>
                    </div></br>
                    <div class="panel-body">
                        <form role="form" action="forgot-action2.php" method="post" name="chngpwd" onSubmit="return valid();">
                            <fieldset>
