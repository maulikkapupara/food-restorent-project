                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <?php 
                                ...
                                if(isset($_REQUEST['EditId'])){
                                    $display="SELECT * FROM addbanner WHERE id='$editid'";
                                    $displayresult = $conn->query($display);
                                    $displayrow = $displayresult->fetch_assoc();
                                    //echo '<pre>'; print_r($displayrow); exit;

                                    $slidertitle = isset($displayrow['slidertitle']) ? $displayrow['slidertitle'] : '';
                            ...
                            <?php                
                                    $seletBanner = "SELECT *FROM addbanner";
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>Copyright © 2021 Nut But Dry-Fruits. All rights reserved. Created By <a href="http://localhost/nutbut/admin/dashboard.php">Nut But Dry-Fruits</a>.
                                </div>
                            </div>
                        </div>
                    </div>
